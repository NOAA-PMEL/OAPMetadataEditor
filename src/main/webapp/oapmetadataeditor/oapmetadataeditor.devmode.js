...
var __gwtModuleFunction = $wnd.oapmetadataeditor;
...
function getCodeServer() {
  ...
  if (idx >= 0) {
    ...
    idx = query.indexOf("gwt.codesvr.oapmetadataeditor=");
    idx += (13 + "oapmetadataeditor".length);  // 
  }
  if (idx >= 0) {
...
//# sourceURL=oapmetadataeditor-0.js

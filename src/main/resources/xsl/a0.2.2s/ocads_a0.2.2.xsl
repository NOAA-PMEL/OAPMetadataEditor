...
<xsl:stylesheet version="2.0" xmlns:oa="http://ncei.noaa.gov/oads/v_a0_2_2s"
    ...
    <html style="overflow-y:scroll;">
      ...
      <body>
        ...
        <div>
          ...
          <a href="http://www.ncei.noaa.gov/" target="_blank">
            <img src="https://www.nodc.noaa.gov/Images/nceilogo-banner.png"/>
          </a>
          ...
          <!--Investigators-->
          <span style="font-weight:bold">INVESTIGATOR(S): </span>
          <br/>
          ...
          <xsl:for-each select="oa:investigators/oa:investigator">
            ...
            <div style="width:900px; margin-left: 30px; text-indent:-20px;">
              ...
              </strong> { <xsl:value-of select="oa:organization"/>, <xsl:if
                test="oa:contactInfo/oa:address/oa:deliveryPoint != ''">
                <xsl:for-each select="oa:contactInfo/oa:address/oa:deliveryPoint">
                  <xsl:apply-templates/>, </xsl:for-each>
              </xsl:if>
              <xsl:if test="oa:contactInfo/oa:address/oa:city != ''">
                <xsl:value-of select="oa:contactInfo/oa:address/oa:city"/>, </xsl:if>
              <xsl:if test="oa:contactInfo/oa:address/oa:administrativeArea != ''">
                <xsl:value-of select="oa:contactInfo/oa:address/oa:administrativeArea"/>, </xsl:if>
              <xsl:if test="oa:contactInfo/oa:address/oa:postalCode != ''">
                <xsl:value-of select="oa:contactInfo/oa:address/oa:postalCode"/>, </xsl:if>
              <xsl:value-of select="oa:contactInfo/oa:address/oa:country"/> } <br/>
            </div>
          ...
          <span style="font-weight:bold">CITE AS: </span>
          <xsl:value-of select="oa:citation"/>
          <br/>
          <br/>
...
-->
          ...
          <span style="font-weight:bold; padding-left:0px; ">IDENTIFICATION INFORMATION FOR THIS DATA PACKAGE: </span>
          <br/>

          <span style="padding-left:20px; font-weight: bold;">NCEI ACCESSION: </span>
          <xsl:value-of select="oa:accn"/>
          <br/>

          <span style="padding-left:20px; font-weight: bold;">NCEI DOI: </span>
          <xsl:value-of select="oa:doi"/>
          <br/>

          <div class="indent">
            <span style="font-weight: bold;">EXPOCODE: </span>
          ...
          <div class="indent">
            <span style="font-weight: bold;">CRUISE ID: </span>
            ...
            <tr>
              <td style="width: 450px;">
                <table style="padding-left:0px; width:430px">
                  <span style="font-weight:bold">TYPES OF STUDY: </span>
                  <br/>
                  <xsl:for-each select="oa:variables/*/oa:observationType[not(preceding::oa:observationType = .)]">
                    <span style="padding-left:20px;"><xsl:value-of select="."/>;</span>
                    <!-- <xsl:apply-templates/> -->
                    <br/>
                  </xsl:for-each>
                  <br/>
                ...
                <span style="font-weight:bold;">TEMPORAL COVERAGE: </span>
                <br/>
                <table style="padding-left:20px; width:500px">
                  <tr>
                    <td style="width: 50%; text-align:left;">START DATE: <xsl:value-of
                        select="oa:temporalExtents/oa:startDate"/></td>
                    <td style="width: 50%; text-align:left;">END DATE: <xsl:value-of
                        select="oa:temporalExtents/oa:endDate"/></td>
                  </tr>
                </table>
                <br/>

                <span style="font-weight:bold;">SPATIAL COVERAGE: </span>
                <br/>
                <xsl:if test="oa:spatialExtents/oa:bounds">
                  <table style="padding-left:20px; width:500px">
                    <tr>
                      <td style="padding-left:110px; text-align:left;">NORTH BOUNDARY: <xsl:value-of
                          select="oa:spatialExtents/oa:bounds/oa:northernBounds"/></td>
                    </tr>
                  </table>

                  <table style="padding-left:20px; width:500px">
                    <tr>
                      <td style="width: 50%; text-align:left;">WEST BOUNDARY: <xsl:value-of
                          select="oa:spatialExtents/oa:bounds/oa:westernBounds"/></td>
                      <td style="width: 50%; text-align:left;">EAST BOUNDARY: <xsl:value-of
                          select="oa:spatialExtents/oa:bounds/oa:easternBounds"/></td>
                    </tr>
                  </table>
                  <table style="padding-left:20px; width:500px">
                    <tr>
                      <td style="padding-left:110px; text-align:left;">SOUTH BOUNDARY: <xsl:value-of
                          select="oa:spatialExtents/oa:bounds/oa:southernBounds"/></td>
                    </tr>
                  </table>
                  <br/>
                </xsl:if>

                <xsl:if test="oa:spatialExtents/oa:location">
                  <table style="padding-left:20px; width:500px">
                    <tr>
                      <td style="width: 50%; text-align:left;">LATITUDE: <xsl:value-of
                          select="oa:spatialExtents/oa:location/oa:latitude"/></td>
                      <td style="width: 50%; text-align:left;">LONGITUDE: <xsl:value-of
                          select="oa:spatialExtents/oa:location/oa:longitude"/></td>
                    </tr>
                  </table>
                </xsl:if>

                <table style="padding-left:0px; width:430px">
                  <span style="font-weight:bold">GEOGRAPHIC NAMES: </span>
                  <br/>
                  ...
                  <xsl:if test="oa:locationOrganism != ''">
                    <br/>
                    <span style="font-weight:bold">LOCATION OF ORGANISM COLLECTION: </span>
                    <br/>
                      ...
                      <xsl:for-each select="oa:platforms/oa:platform">
                        <xsl:choose>
                          <xsl:when test="oa:identifier = ''">
                            <xsl:value-of select="oa:name"/>; </xsl:when>
                          <xsl:otherwise>
                            <xsl:value-of select="oa:name"/> (ID (<xsl:value-of select="oa:identifier/@type"/>):
                              <xsl:value-of select="oa:identifier"/>); </xsl:otherwise>
                        </xsl:choose>
                        <br/>
                      </xsl:for-each>
                    </div>
                  ...
                  <span style="font-weight:bold">RESEARCH PROJECT(S): </span>
                  <br/>
              ...
              <td style="width:450px; height:400px;">
                <a href="{link_img}" target="_blank">
                  <img src="{link_img}" style="max-width:420px; max-height:400px;"/>
                </a>
              </td>
          ...
          <span style="font-weight:bold">DATA PACKAGES RELATED TO THIS ONE:</span>
          <br/>
          <xsl:if test="oa:related/oa:name != ''">
            <span style="padding-left:20px;"/> NCEI Accession(s) <xsl:for-each select="oa:related">
              <a href="{link}"><xsl:value-of select="oa:name"/></a>; </xsl:for-each>
          </xsl:if>

          <br/>
          <br/>

          <span style="font-weight:bold">PUBLICATIONS DESCRIBING THIS DATA SET: </span>
          <br/>
          ...
          <ul>
            <xsl:for-each select="oa:fundingInfo/oa:source">
              <li>
                <span style="padding-left:20px;">
                  <xsl:value-of select="oa:agency"/>
                </span>
                <br/>
                <span style="font-style:italic; padding-left:40px;">PROJECT TITLE: </span>
                <xsl:value-of select="oa:title"/>
                <br/>
                <span style="font-style:italic; padding-left:40px;">PROJECT ID: </span>
                <xsl:value-of select="oa:identifier"/>
                <br/>
                <br/>
              </li>
            </xsl:for-each>
          ...
          <xsl:for-each select="oa:dataSubmitter">
            <span style="padding-left:3px;"><xsl:value-of select="oa:name"/> (<xsl:value-of
                select="oa:contactInfo/oa:email"/>) </span>
            <br/>
          </xsl:for-each>
          <br/>
  ...
  <xsl:template name="variables" match="oa:variables">
    ...
    <xsl:for-each select="oa:variable[@xsi:type = 'dic_variable_type'] | oa:dic">
      ...
      <table width="940">
        ...
        <xsl:if test="oa:fullName != ''">
          <tr>
            <td class="desc">Name: </td>
            <td class="val">
              <xsl:value-of select="oa:fullName"/>
            </td>
          </tr>
        </xsl:if>
        ...
        <xsl:if test="oa:datasetVarName != ''">
          <tr>
            <td class="desc">Dataset Variable Name: </td>
            <td class="val">
              <xsl:value-of select="oa:datasetVarName"/>
            </td>
          </tr>
        </xsl:if>

        <xsl:if test="oa:units != ''">
          <tr>
            <td class="desc">Units: </td>
            <td class="val">
              <xsl:value-of select="oa:units"/>
            </td>
          </tr>
        </xsl:if>

        <xsl:if test="oa:observationType != ''">
          <tr>
            <td class="desc">Observation type: </td>
            <td class="val">
              <xsl:value-of select="oa:observationType"/>
            </td>
          </tr>
        </xsl:if>

        <xsl:if test="oa:variableType != ''">
          <tr>
            <td class="desc">Variable type: </td>
            <td class="val">
              <xsl:value-of select="oa:variableType"/>
            </td>
          </tr>
        </xsl:if>

        <xsl:if test="oa:calcMethod != ''">
          <tr>
            <td class="desc">Calculation method and parameters: </td>
            <td class="val">
              <xsl:value-of select="oa:calcMethod"/>
            </td>
          </tr>
        </xsl:if>

        <xsl:if test="oa:samplingInstrument != ''">
          <tr>
            <td class="desc">Sampling instrument: </td>
            <td class="val">
              <xsl:value-of select="oa:samplingInstrument"/>
            </td>
          </tr>
        </xsl:if>
        ...
        <xsl:if test="oa:analyzingInstrument != ''">
          <tr>
            ...
            <td class="val">
              <xsl:value-of select="oa:analyzingInstrument"/>
            </td>
          </tr>
        </xsl:if>

        <xsl:if test="oa:detailedInfo != ''">
          <tr>
            <td class="desc">Detailed sampling and analyzing information: </td>
            <td class="val">
              <xsl:value-of select="oa:detailedInfo"/>
            </td>
          </tr>
        </xsl:if>

        <xsl:if test="oa:replicate != ''">
          <tr>
            <td class="desc">Replicate information: </td>
            <td class="val">
              <xsl:value-of select="oa:replicate"/>
            </td>
          </tr>
        </xsl:if>
        ...
        <xsl:for-each select="oa:standard">
          ...
          <xsl:if test="oa:frequency != ''">
            <tr>
              ...
              <td class="val">
                <xsl:value-of select="oa:frequency"/>
              </td>
            </tr>
          </xsl:if>
          ...
          <xsl:for-each select="oa:crm">
            ...
            <xsl:if test="oa:manufacturer != ''">
              <tr>
                ...
                <td class="val">
                  <xsl:value-of select="oa:manufacturer"/>
                </td>
              </tr>
            </xsl:if>
        ...
        <xsl:for-each select="oa:poison">
          ...
          <xsl:if test="oa:poisonName != ''">
            <tr>
              <td class="desc">Poison name: </td>
              <td class="val">
                <xsl:value-of select="oa:poisonName"/>
              </td>
            </tr>
          </xsl:if>
          ...
          <xsl:if test="oa:volume != ''">
            <tr>
              ...
              <td class="val">
                <xsl:value-of select="oa:volume"/>
              </td>
            </tr>
          </xsl:if>

          <xsl:if test="oa:correction != ''">
            <tr>
              <td class="desc">Poison correction: </td>
              <td class="val">
                <xsl:value-of select="oa:correction"/>
              </td>
            </tr>
          </xsl:if>
        ...
        <xsl:if test="oa:uncertainty != ''">
          <tr>
            ...
            <td class="val">
              <xsl:value-of select="oa:uncertainty"/>
            </td>
          </tr>
        </xsl:if>
        ...
        <xsl:if test="oa:qcFlag/oa:description != ''">
          <tr>
            ...
            <td class="val">
              <xsl:value-of select="oa:qcFlag/oa:description"/>
            </td>
          </tr>
        </xsl:if>
        ...
        <xsl:if test="oa:methodReference != ''">
          <tr>
            ...
            <td class="val">
              <xsl:value-of select="oa:methodReference"/>
            </td>
          </tr>
        </xsl:if>
        ...
        <xsl:if test="oa:researcher/oa:name != ''">
          <tr>
            ...
            <td class="val">
              <xsl:value-of select="oa:researcher/oa:name"/>
            </td>
          </tr>
        </xsl:if>
        ...
        <xsl:if test="oa:researcher/oa:organization != ''">
          <tr>
            ...
            <td class="val">
              <xsl:value-of select="oa:researcher/oa:organization"/>
            </td>
          </tr>
        </xsl:if>
    ...
    <xsl:for-each select="oa:variable[@xsi:type = 'ta_variable_type'] | oa:ta">
      ...
      <table width="940">
        ...
        <xsl:if test="oa:measured != ''">
          <tr>
            <td class="desc">Measured or calculated: </td>
            <td class="val">
              <xsl:value-of select="oa:measured"/>
            </td>
          </tr>
        </xsl:if>
        ...
        <xsl:if test="oa:titrationType != ''">
          <tr>
            ...
            <td class="val">
              <xsl:value-of select="oa:titrationType"/>
            </td>
          </tr>
        </xsl:if>
        ...
        <xsl:if test="oa:cellType != ''">
          <tr>
            ...
            <td class="val">
              <xsl:value-of select="oa:cellType"/>
            </td>
          </tr>
        </xsl:if>
        ...
        <xsl:if test="oa:curveFitting != ''">
          <tr>
            ...
            <td class="val">
              <xsl:value-of select="oa:curveFitting"/>
            </td>
          </tr>
        </xsl:if>
        ...
        <xsl:if test="oa:blank != ''">
          <tr>
            <td class="desc">TA blank correction: </td>
            <td class="val">
              <xsl:value-of select="oa:blank"/>
            </td>
          </tr>
        </xsl:if>
      ...
      <table width="940">
        ...
        <xsl:if test="oa:phScale != ''">
          <tr>
            ...
            <td class="val">
              <xsl:value-of select="oa:phScale"/>
            </td>
          </tr>
        </xsl:if>
        ...
        <xsl:if test="oa:temperatureMeasure != ''">
          <tr>
            <td class="desc">Temperature of pH measurement: </td>
            <td class="val">
              <xsl:value-of select="oa:temperatureMeasure"/>
            </td>
          </tr>
        </xsl:if>
        ...
        <xsl:for-each select="oa:standardization">
          ...
          <xsl:if test="oa:phOfStandards != ''">
            <tr>
              ...
              <td class="val">
                <xsl:value-of select="oa:phOfStandards"/>
              </td>
            </tr>
          </xsl:if>
          ...
          <xsl:if test="oa:temperature != ''">
            <tr>
              ...
              <td class="val">
                <xsl:value-of select="oa:temperature"/>
              </td>
            </tr>
          </xsl:if>
        ...
        <xsl:if test="oa:temperatureCorrectionMethod != ''">
          <tr>
            ...
            <td class="val">
              <xsl:value-of select="oa:temperatureCorrectionMethod"/>
            </td>
          </tr>
        </xsl:if>
        ...
        <xsl:if test="oa:phReportTemperature != ''">
          <tr>
            ...
            <td class="val">
              <xsl:value-of select="oa:phReportTemperature"/>
            </td>
          </tr>
        </xsl:if>
    ...
    <xsl:for-each
      select="oa:variable[@xsi:type = 'co2a_variable_type'] | oa:co2a | oa:variable[@xsi:type = 'co2_socat']">
      <hr/>
      ...
      <table width="940">
        ...
        <xsl:if test="oa:locationSeawaterIntake != ''">
          <tr>
            ...
            <td class="val">
              <xsl:value-of select="oa:locationSeawaterIntake"/>
            </td>
          </tr>
        </xsl:if>
        ...
        <xsl:if test="oa:depthSeawaterIntake != ''">
          <tr>
            ...
            <td class="val">
              <xsl:value-of select="oa:depthSeawaterIntake"/>
            </td>
          </tr>
        </xsl:if>
        ...
        <xsl:if test="oa:measurementFrequency != ''">
          <tr>
            <td class="desc">Measurement Frequency: </td>
            <td class="val">
              <xsl:value-of select="oa:measurementFrequency"/>
            </td>
          </tr>
        </xsl:if>

        <xsl:if test="oa:environmentalControl != ''">
          <tr>
            <td class="desc">Environmental control: </td>
            <td class="val">
              <xsl:value-of select="oa:environmentalControl"/>
            </td>
          </tr>
        </xsl:if>

        <xsl:if test="oa:analysisCO2comparison != ''">
          <tr>
            <td class="desc">Analysis of CO2 comparison: </td>
            <td class="val">
              <xsl:value-of select="oa:analysisCO2comparison"/>
            </td>
          </tr>
        </xsl:if>

        <xsl:if test="oa:measuredCO2params != ''">
          <tr>
            <td class="desc">Measured CO2 parameters: </td>
            <td class="val">
              <xsl:value-of select="oa:measuredCO2params"/>
            </td>
          </tr>
        </xsl:if>

        <xsl:if test="oa:numberNonZeroGasStds != ''">
          <tr>
            <td class="desc">Number of none zero standards: </td>
            <td class="val">
              <xsl:value-of select="oa:numberNonZeroGasStds"/>
            </td>
          </tr>
        </xsl:if>
        ...
        <xsl:for-each select="oa:equilibrator">
          ...
          <xsl:if test="oa:waterFlowRate != ''">
            <tr>
              ...
              <td class="val">
                <xsl:value-of select="oa:waterFlowRate"/>
              </td>
            </tr>
          </xsl:if>
          ...
          <xsl:if test="oa:gasFlowRate != ''">
            <tr>
              ...
              <td class="val">
                <xsl:value-of select="oa:gasFlowRate"/>
              </td>
            </tr>
          </xsl:if>

          <xsl:if test="oa:temperatureEquilibratorMethod != ''">
            <tr>
              <td class="desc">How was temperature inside the equilibrator measured: </td>
              <td class="val">
                <xsl:value-of select="oa:temperatureEquilibratorMethod"/>
              </td>
            </tr>
          </xsl:if>
          ...
          <xsl:for-each select="oa:equilibratorTemp">
            ...
            <xsl:if test="oa:location != ''">
              <tr>
                <td class="desc">Equilibrator temperature location: </td>
                <td class="val">
                  <xsl:value-of select="oa:location"/>
                </td>
              </tr>
            </xsl:if>
            ...
            <xsl:if test="oa:model != ''">
              <tr>
                <td class="desc">Equilibrator temperature sensor model: </td>
                <td class="val">
                  <xsl:value-of select="oa:model"/>
                </td>
              </tr>
            </xsl:if>

            <xsl:if test="oa:accuracy != ''">
              <tr>
                <td class="desc">Equilibrator temperature sensor accuracy: </td>
                <td class="val">
                  <xsl:value-of select="oa:accuracy"/>
                </td>
              </tr>
            </xsl:if>

            <xsl:if test="oa:precision != ''">
              <tr>
                <td class="desc">Equilibrator temperature sensor precision: </td>
                <td class="val">
                  <xsl:value-of select="oa:precision"/>
                </td>
              </tr>
            </xsl:if>

            <xsl:if test="oa:calibration != ''">
              <tr>
                <td class="desc">Equilibrator temperature sensor calibration: </td>
                <td class="val">
                  <xsl:value-of select="oa:calibration"/>
                </td>
              </tr>
            </xsl:if>

            <xsl:if test="oa:warming != ''">
              <tr>
                <td class="desc">Equilibrator temperature warming: </td>
                <td class="val">
                  <xsl:value-of select="oa:warming"/>
                </td>
              </tr>
            </xsl:if>

            <xsl:if test="oa:otherComments != ''">
              <tr>
                <td class="desc">Equilibrator temperature other comments: </td>
                <td class="val">
                  <xsl:value-of select="oa:otherComments"/>
                </td>
              </tr>
            </xsl:if>
          ...
          <xsl:if test="oa:pressureEquilibratorMethod != ''">
            <tr>
              <td class="desc">How was pressure inside the equilibrator measured: </td>
              <td class="val">
                <xsl:value-of select="oa:pressureEquilibratorMethod"/>
              </td>
          ...
          <xsl:if test="oa:dryMethod != ''">
            <tr>
              ...
              <td class="val">
                <xsl:value-of select="oa:dryMethod"/>
              </td>
            </tr>
          </xsl:if>
        ...
        <xsl:for-each select="oa:gasDetector">
          ...
          <xsl:if test="oa:resolution != ''">
            <tr>
              <td class="desc">SEA CO2 gas detector resolution: </td>
              <td class="val">
                <xsl:value-of select="oa:resolution"/>
              </td>
            </tr>
          </xsl:if>
        ...
        <xsl:for-each select="oa:standardization">
          ...
          <xsl:for-each select="oa:standardgas">
            ...
            <xsl:if test="oa:concentration != ''">
              <tr>
                <td class="desc">Standard gas concentration: </td>
                <td class="val">
                  <xsl:value-of select="oa:concentration"/>
                </td>
              </tr>
            </xsl:if>
        ...
        <xsl:if test="oa:waterVaporCorrection != ''">
          <tr>
            <td class="desc">Water vapor correction method: </td>
            <td class="val">
              <xsl:value-of select="oa:waterVaporCorrection"/>
            </td>
          </tr>
        </xsl:if>

        <xsl:if test="oa:temperatureCorrection != ''">
          <tr>
            <td class="desc">Temperature correction method: </td>
            <td class="val">
              <xsl:value-of select="oa:temperatureCorrection"/>
            </td>
          </tr>
        </xsl:if>

        <xsl:if test="oa:co2ReportTemperature != ''">
          <tr>
            <td class="desc">At what temperature was pCO2 reported: </td>
            <td class="val">
              <xsl:value-of select="oa:co2ReportTemperature"/>
            </td>
          </tr>
        </xsl:if>
        ...
        <xsl:for-each select="oa:atmCO2">
          ...
          <xsl:if test="oa:measurement != ''">
            <tr>
              <td class="desc">Atmosphere CO2 measurement frequency: </td>
              <td class="val">
                <xsl:value-of select="oa:measurement"/>
              </td>
            </tr>
          </xsl:if>

          <xsl:if test="oa:locationAndHeight != ''">
            <tr>
              <td class="desc">Atmosphere CO2 measurement location and height: </td>
              <td class="val">
                <xsl:value-of select="oa:locationAndHeight"/>
              </td>
            </tr>
          </xsl:if>
    ...
    <xsl:for-each select="variable[@xsi:type = 'co2d_variable_type'] | oa:co2d">
      ...
      <table width="940">
        ...
        <xsl:if test="oa:storageMethod != ''">
          <tr>
            <td class="desc">Storage method: </td>
            <td class="val">
              <xsl:value-of select="oa:storageMethod"/>
            </td>
          </tr>
        </xsl:if>

        <xsl:if test="oa:seawatervol != ''">
          <tr>
            <td class="desc">Seawater volume: </td>
            <td class="val">
              <xsl:value-of select="oa:seawatervol"/>
            </td>
          </tr>
        </xsl:if>

        <xsl:if test="oa:headspacevol != ''">
          <tr>
            <td class="desc">Headspace volume: </td>
            <td class="val">
              <xsl:value-of select="oa:headspacevol"/>
            </td>
          </tr>
        </xsl:if>
        ...
        <xsl:for-each select="oa:standardization">
          ...
          <xsl:if test="oa:temperatureStd != ''">
            <tr>
              <td class="desc">Temperature of standardization: </td>
              <td class="val">
                <xsl:value-of select="oa:temperatureStd"/>
              </td>
            </tr>
          </xsl:if>
...
-->
        ...
        <xsl:if test="oa:controlledName != ''">
          <tr>
            <td class="desc">Controlled vocabulary name: </td>
            <td class="val">
              <xsl:value-of select="oa:controlledName"/>
            </td>
          </tr>
        </xsl:if>
        ...
        <xsl:if test="oa:sensorManufacturer != ''">
          <tr>
            <td class="desc">Sensor manufacturer: </td>
            <td class="val">
              <xsl:value-of select="oa:sensorManufacturer"/>
            </td>
          </tr>
        </xsl:if>

        <xsl:if test="oa:sensorModel != ''">
          <tr>
            <td class="desc">Sensor model: </td>
            <td class="val">
              <xsl:value-of select="oa:sensorModel"/>
            </td>
          </tr>
        </xsl:if>

        <xsl:if test="oa:sensorResolution != ''">
          <tr>
            <td class="desc">Sensor resolution: </td>
            <td class="val">
              <xsl:value-of select="oa:sensorResolution"/>
            </td>
          </tr>
        </xsl:if>

        <xsl:if test="oa:sensorCalibration != ''">
          <tr>
            <td class="desc">Sensor calibration: </td>
            <td class="val">
              <xsl:value-of select="oa:sensorCalibration"/>
            </td>
          </tr>
        </xsl:if>

        <xsl:if test="oa:sensorDepth != ''">
          <tr>
            <td class="desc">Sensor depth: </td>
            <td class="val">
              <xsl:value-of select="oa:sensorDepth"/>
            </td>
          </tr>
        </xsl:if>
        ...
        <xsl:if test="oa:duration != ''">
          <tr>
            ...
            <td class="val">
              <xsl:value-of select="oa:duration"/>
            </td>
          </tr>
        </xsl:if>
        ...
        <xsl:if test="oa:biologicalSubject != ''">
          <tr>
            ...
            <td class="val">
              <xsl:value-of select="oa:biologicalSubject"/>
            </td>
          </tr>
        </xsl:if>
        ...
        <xsl:if test="oa:speciesID != ''">
          <tr>
            ...
            <td class="val">
              <xsl:value-of select="oa:speciesID"/>
            </td>
          </tr>
        </xsl:if>

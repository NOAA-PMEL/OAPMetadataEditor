...
public class SizedEditTextCell
    extends AbstractEditableCell<String, SizedEditTextCell.ViewData> {
...
//            @Template("<input type=\"text\" value=\"{0}\" tabindex=\"-1\" size=\"{1}\"></input>")
         ...
         */
        public SizedEditTextCell() {
            this(SimpleSafeHtmlRenderer.getInstance());
        }

        public SizedEditTextCell(int inputWidth) {
            this(SimpleSafeHtmlRenderer.getInstance());
            this.inputWidth = inputWidth;
        }
         ...
         */
        public SizedEditTextCell(SafeHtmlRenderer<String> renderer) {

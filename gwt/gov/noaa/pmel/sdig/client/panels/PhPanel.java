...
public class PhPanel extends Composite implements GetsDirty<Variable> {
    ...
    public PhPanel() {
        ...
        common.abbreviationModal.setTitle("22.1 Column header name of the variable in the data files, e.g., pH");
        common.observationTypeModal.setTitle("22.2 How the variable is observed, e.g., surface underway, profile, time series, etc.");
        ...
        common.detailedInformationModal.setTitle("22.5 Detailed description of the analyzing procedures, including the citation of the SOP used for the analysis (e.g. SOP 3a;  Dickson, A.G., Sabine, C.L. and Christian, J.R.  2007.  Guide to Best Practices for Ocean CO2  Measurements).");
        common.fieldReplicateModal.setTitle("22.12 Repetition of sample collection and measurement, e.g., triplicate samples.");
        common.uncertaintyModal.setTitle("22.10 Uncertainty of the results (e.g., 1%, 2 μmol/kg), or any pieces of information that are related to the quality control of the variable.");
        ...
        common.qcSchemeNameModal.setTitle("22.9  Data quality flag scheme");
        ...
        common.sopChangesModal.setTitle("22.21 Indicate if any changes were made to the method as described in the SOP, such as changes in the sample collection method, changes in storage of the sample, different volume, changes to the CRM used, etc. Please provide a detailed list of  all of the changes made.");
        common.collectionMethodModal.setTitle("22.3 Method that is used to collect water samples, or deploy sensors, etc. For example, bottle collection with a Niskin bottle, pump, CTD, etc is a collection method.");
        // ??? see detailedInformationModal
        common.analyzingInformationModal.setTitle("22.5 Detailed description of the analyzing procedures, including the citation of the SOP used for the analysis (e.g. SOP 3a;  Dickson, A.G., Sabine, C.L. and Christian, J.R.  2007.  Guide to Best Practices for Ocean CO2  Measurements).");

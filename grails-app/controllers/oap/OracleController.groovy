    ...
    def variable() {
        ...
        if (query) {
            for (int i = 0; i < variables.size(); i++) {
                if (variables.get(i).toLowerCase().contains(query)) {
                    NceiSuggestion v = new NceiSuggestion();
                    v.setSuggestion(variables.get(i))
                    suggestions.add(v)
                }
            }
        }
    ...
    def instrument() {
        ...
        if (query) {
            for (int i = 0; i < instruments.size(); i++) {
                if (instruments.get(i).toLowerCase().contains(query)) {
                    NceiSuggestion v = new NceiSuggestion();
                    v.setSuggestion(instruments.get(i))
                    suggestions.add(v)
                }
            }
        }
